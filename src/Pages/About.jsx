...
const ProfileImage = memo(() => (
  <div className="flex justify-center lg:justify-end items-center sm:p-6 p-0">
...
const AboutPage = () => {
  ...
  return (
    <div
      className="h-auto pb-16 lg:pb-24 text-white overflow-hidden px-[5%] sm:px-[5%] lg:px-[10%] pt-12"
      id="About"
      itemScope
    ...
    >
      ...
      <div className="w-full mx-auto pt-6 relative">
        <div className="flex flex-col-reverse lg:grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          {/* Kolom Teks Sebelah Kiri dengan Spasi yang Lebih Proporsional */}
          <div className="space-y-6 text-center lg:text-left">
            ...
            <p
              className="text-base sm:text-lg text-gray-400 leading-relaxed text-justify lg:text-left"
              data-aos="fade-right"
              data-aos-duration="1500"
            >
              Saya adalah mahasiswa Teknik Informatika yang sangat antusias
              dengan pengembangan web, khususnya dalam hal membangun antarmuka (
              <span className="text-gray-200 font-medium">frontend</span>) dan
              merancang visual{" "}
              <span className="text-gray-200 font-medium">UI/UX</span> yang
              interaktif. Saya berdedikasi untuk menciptakan pengalaman digital
              yang menarik, terstruktur, serta menyajikan solusi visualisasi
              data dan dashboard terbaik dalam setiap proyek yang saya kerjakan.
            </p>
