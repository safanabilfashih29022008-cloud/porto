...
const SOCIAL_LINKS = [
  ...
  {
    icon: Linkedin,
    link: "https://www.linkedin.com/in/ekizr/",
    label: "LinkedIn Profile",
  },
  {
    icon: Instagram,
    link: "https://www.instagram.com/ekizr_/?hl=id",
...
const Home = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Safa Nabil Fashih — Frontend Web Developer</title>
        <meta
          name="description"
          content="Website resmi Safa Nabil Fashih, Front-End Web Developer. Saya berfokus pada penciptaan pengalaman digital yang menarik dan selalu berupaya memberikan solusi terbaik dalam setiap proyek yang saya kerjakan."
        />
        <meta name="robots" content="index, follow" />
        <link rel="canonical" href="https://safa.com" />
        <meta
          property="og:title"
          content="Safa Nabil Fashih — Frontend Web Developer"
        />
        <meta
          property="og:description"
          content="Website resmi dan portofolio Safa Nabil Fashih, Front-End Web Developer."
        />
        <meta property="og:url" content="https://safa.com" />
        <meta property="og:type" content="website" />
        <script type="application/ld+json">{`
          {
            "@context": "https://schema.org",
            "@type": "Person",
            "name": "Safa Nabil Fashih",
