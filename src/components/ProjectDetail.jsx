...
const ProjectDetails = () => {
  ...
  useEffect(() => {
    ...
    if (selectedProject) {
      const enhancedProject = {
        ...
        Github: selectedProject.Github || "https://github.com/Safnf",
      };
  ...
  const projectUrl = `https://Safnf.com/project/${toSlug(project.Title)}`;

  return (
    <>
      <Helmet>
        <title>{project.Title} — Safa Nabil Fashih</title>
        <meta
          name="description"
          content={
            project.Description
              ? project.Description.slice(0, 155)
              : `Project ${project.Title} oleh Safa Nabil Fashih — Frontend Web Developer.`
          }
        />
        ...
        <meta
          property="og:title"
          content={`${project.Title} — Safa Nabil Fashih`}
        />
        <meta
